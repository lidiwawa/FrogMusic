...
interface IMod {
    ...
    importPlaylists: (platform: string, playlistIds: string[]) => Promise<{ success: boolean; imported?: Array<{id: string; title: string; count: number}>; failed?: string[] }>,
    getUserPlaylists: (platform: string) => Promise<{ success: boolean; reason?: string; playlists?: Array<{id: string; title: string; count: number}> }>,
    getNeteaseRecommendations: () => Promise<{ success: boolean; reason?: string; recommendations?: NeteaseRecommendation[] }>,
    loginPlatform: (platform: string) => Promise<{ success: boolean; reason?: string; playlists?: Array<{id: string; title: string; count: number}> }>,
}
...
const PluginManager = {
    ...
    loginPlatform: mod.loginPlatform,
    getUserPlaylists: mod.getUserPlaylists,
    getNeteaseRecommendations: mod.getNeteaseRecommendations,
    importPlaylists: mod.importPlaylists,
};
