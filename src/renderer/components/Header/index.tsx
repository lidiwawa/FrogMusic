...
export default function AppHeader() {
    ...
    return (
        <div className="header-container">
            <div className="left-part header-cluster header-cluster--nav">
                <div className="logo">
            ...
            <div className="header-cluster header-cluster--search">
                <div className="header-badge">SIGNAL</div>
            ...
            <div className="right-part header-cluster header-cluster--actions">
                ...
                <div className="header-action-group header-action-group--window">
                    <div
                        role="button"
