...
import DailyRecommendationsView from "./views/daily-recommendations-view";
import RecommendationQueueView from "./views/recommendation-queue-view";
    ...
    return (
        <div className="main-page-shell">
            ...
            <div className="main-page-workspace">
                <div className="main-page-workspace__surface">
                    <Routes>
                        ...
                        <Route
                            ...
                            element={<DailyRecommendationsView></DailyRecommendationsView>}
                        ></Route>
                        <Route
                            path="recommendation/:kind"
                            element={<RecommendationQueueView></RecommendationQueueView>}
                        ></Route>
                        <Route
                            path="recently_play"
