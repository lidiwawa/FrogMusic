...
class WindowManager implements IWindowManager {
    ...
    private static readonly miniModeWindowSize = {
        width: 230,
        height: 36,
    };
    ...
    private createMiniModeWindow() {
        ...
        const { width, height } = WindowManager.miniModeWindowSize;
        ...
        miniWindow.webContents.closeDevTools();
    ...
    public showMiniModeWindow() {
        const isNewWindow = !WindowManager.miniModeWindow;
        if (!WindowManager.miniModeWindow) {
