...
// 应用更新链接
const upstreamBrandName = "Music" + "Free";
const upstreamDesktopName = upstreamBrandName + "Desktop";
export const appUpdateSources = [
    `https://gitee.com/maotoumao/${upstreamDesktopName}/raw/master/release/version.json`,
    `https://raw.githubusercontent.com/maotoumao/${upstreamDesktopName}/master/release/version.json`,
    `https://cdn.jsdelivr.net/gh/maotoumao/${upstreamDesktopName}@master/release/version.json`,
];
